...
local TeamColor = Color3.new(183, 19, 255)
...
Options('Enabled', 'Rage Esp', true);
Options('VisCheck', 'Legit ESP', false);
Options('ShowBoxes', 'Boxes', true);
Options('ShowName', 'Show Names', true);
Options('ShowHealth', 'Health', true);
Options('ShowTracers', 'Tracers', true);
Options('ShowDot', 'Show Head Dot', false);
Options('Crosshair', 'Better Crosshair', false);
Options('ShowTeam', 'Show Team', true);
Options('ShowTeamColor', 'Show Team Color', false);
Options('ShowDistance', 'Distance', false);
Options('TextOutline', 'Text Outline', true);
Options('YOffset', 'Offset', 0, -200, 200);
Options('TextSize', 'Text Size', syn and 18 or 14, 10, 24); -- cuz synapse fonts look weird???
Options('MaxDistance', 'Max Distance', 2500, 100, 25000);
Options('RefreshRate', 'Refresh Rate (ms)', 5, 1, 200);
Options('MenuKey', 'Open/Close', Enum.KeyCode.F5, 1);
...
function CreateMenu(NewPosition) -- Create Menu
	...
	Menu:AddMenuInstance('TopBarText', 'Text', {
		Size 		= 25;
		Position	= shared.MenuDrawingData.Instances.TopBarTwo.Position + V2New(12, 6);
		Text		= 'Blade Universal Esp';
	...
	Menu:AddMenuInstance('TopBarTextBR', 'Text', {
		Size 		= 17;
		Position	= shared.MenuDrawingData.Instances.TopBarTwo.Position + V2New(BaseSize.X - 90, 28);
		Text		= 'by Bladesify';
